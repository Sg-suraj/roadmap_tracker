document.addEventListener('DOMContentLoaded', () => {
    ...
    function createTaskCard(task) {
        ...
        const createdDate = task.created_at ? new Date(task.created_at._seconds * 1000).toLocaleDateString() : '';
            ...
            new Sortable(column, {
                ...
                onEnd: async function(evt) {
                    ...
                    try {
                        ...
                        updateTaskCounts();
                        // Re-fetch progress to update the summary
    ...
    newTaskForm?.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const list = document.getElementById(`${newTask.status}-list`);
            list.appendChild(createTaskCard(newTask));
            updateTaskCounts();
